...
- Requests to show/list orders across all stores (for example "show all stores'
  orders" or "sary stores k orders dikhao") use operation=list,
  group_by=none, and status=all. They are not a specific-store request.
